    ...
    >
      ...
      >
        ...
        <section style={{ textAlign: "center", marginBottom: "30px" }}>
          ...
          >
            우리 플랫폼은 복잡한 데이터를 직관적이고 아름다운 시각화로 변환하여, 사용자들이 손쉽게 데이터를 분석하고
            인사이트를 도출할 수 있도록 도와줍니다. 다양한 차트와 그래프를 제공하여 모든 종류의 데이터에 적합한
            시각화 도구를 찾을 수 있습니다.
          </p>
        </section>
        ...
        <section style={{ marginBottom: "30px" }}>
          ...
          >
            ...
            >
              ...
              <p style={{ fontSize: "0.95rem", lineHeight: "1.5", color: "#555" }}>
                바 차트, 라인 차트, 파이 차트 등 다양한 차트 유형을 지원하여 모든 데이터에 적합한 시각화를
                구현할 수 있습니다.
              </p>
            </div>
            <div
